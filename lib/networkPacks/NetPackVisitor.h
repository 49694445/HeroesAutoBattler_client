...
public:
	...
	virtual void visitSetArenaCreatureExperience(SetArenaCreatureExperience & pack) {}
	virtual void visitSetArenaHeroLevelUpChoiceTimeout(SetArenaHeroLevelUpChoiceTimeout & pack) {}
	virtual void visitSetArenaBattleResultTimeout(SetArenaBattleResultTimeout & pack) {}
	virtual void visitSetArenaRecruitState(SetArenaRecruitState & pack) {}
	virtual void visitSetArenaBattleCreatureProgress(SetArenaBattleCreatureProgress & pack) {}
	virtual void visitSetArenaSummonsRemaining(SetArenaSummonsRemaining & pack) {}
	virtual void visitArenaDeploymentStarted(ArenaDeploymentStarted & pack) {}
	virtual void visitArenaNativeProbeResult(ArenaNativeProbeResult & pack) {}
	virtual void visitArenaArtifactDraftSelection(ArenaArtifactDraftSelection & pack) {}
	virtual void visitArenaDailyResourceGrant(ArenaDailyResourceGrant & pack) {}
	virtual void visitArenaDisconnectWaitState(ArenaDisconnectWaitState & pack) {}
	virtual void visitArenaCommandChannelClientRequest(ArenaCommandChannelClientRequest & pack) {}
	virtual void visitSetArenaTownVisitState(SetArenaTownVisitState & pack) {}
	virtual void visitSetArenaTownBuildGateState(SetArenaTownBuildGateState & pack) {}
	virtual void visitSetArenaMainHero(SetArenaMainHero & pack) {}
	virtual void visitSetArenaBuildLevelState(SetArenaBuildLevelState & pack) {}
	virtual void visitSetArenaTownSummonState(SetArenaTownSummonState & pack) {}
	virtual void visitSetArenaHealth(SetArenaHealth & pack) {}
	...
	virtual void visitSetStackArenaInitialUnit(SetStackArenaInitialUnit & pack) {}
	...
	virtual void visitArenaDeploymentReady(ArenaDeploymentReady & pack) {}
	virtual void visitArenaDeploymentPlanCommit(ArenaDeploymentPlanCommit & pack) {}
	virtual void visitArenaNativeProbeRequest(ArenaNativeProbeRequest & pack) {}
	virtual void visitArenaArtifactDraftPick(ArenaArtifactDraftPick & pack) {}
	virtual void visitArenaRecruitAction(ArenaRecruitAction & pack) {}
	virtual void visitArenaTownVisitRequest(ArenaTownVisitRequest & pack) {}
	virtual void visitArenaSetMainHeroRequest(ArenaSetMainHeroRequest & pack) {}
	virtual void visitArenaBuildLevelQuoteRequest(ArenaBuildLevelQuoteRequest & pack) {}
	virtual void visitArenaBuildDwellingWithLevel(ArenaBuildDwellingWithLevel & pack) {}
	virtual void visitArenaSummonFromTown(ArenaSummonFromTown & pack) {}
	virtual void visitArenaCommandChannelClientResponse(ArenaCommandChannelClientResponse & pack) {}
	...
	virtual void visitLobbyAuthRequest(LobbyAuthRequest & pack) {}
	virtual void visitLobbyAuthResult(LobbyAuthResult & pack) {}
	virtual void visitLobbyServerRedirect(LobbyServerRedirect & pack) {}
	virtual void visitLobbyClientDisconnected(LobbyClientDisconnected & pack) {}
	virtual void visitLobbyClientAbandonGame(LobbyClientAbandonGame & pack) {}
	...
	virtual void visitLobbySetPlayerReady(LobbySetPlayerReady & pack) {}

...
void SetArenaRecruitState::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaRecruitState(*this);
}

void SetArenaBattleCreatureProgress::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaBattleCreatureProgress(*this);
}

void SetArenaSummonsRemaining::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaSummonsRemaining(*this);
}

void SetArenaCreatureExperience::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaCreatureExperience(*this);
}

void SetArenaHeroLevelUpChoiceTimeout::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaHeroLevelUpChoiceTimeout(*this);
}

void SetArenaBattleResultTimeout::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaBattleResultTimeout(*this);
}

void ArenaDeploymentStarted::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaDeploymentStarted(*this);
}

void ArenaNativeProbeRequest::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaNativeProbeRequest(*this);
}
void ArenaNativeProbeResult::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaNativeProbeResult(*this);
}

void ArenaArtifactDraftSelection::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaArtifactDraftSelection(*this);
}

void ArenaDailyResourceGrant::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaDailyResourceGrant(*this);
}

void ArenaDisconnectWaitState::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaDisconnectWaitState(*this);
}

void ArenaCommandChannelClientRequest::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaCommandChannelClientRequest(*this);
}

void SetArenaTownVisitState::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaTownVisitState(*this);
}

void SetArenaTownBuildGateState::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaTownBuildGateState(*this);
}

void SetArenaMainHero::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaMainHero(*this);
}

void SetArenaBuildLevelState::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaBuildLevelState(*this);
}

void SetArenaTownSummonState::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaTownSummonState(*this);
}

void SetArenaHealth::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetArenaHealth(*this);
}
...
void SetStackArenaInitialUnit::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitSetStackArenaInitialUnit(*this);
}
...
void ArenaRecruitAction::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaRecruitAction(*this);
}

void ArenaTownVisitRequest::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaTownVisitRequest(*this);
}

void ArenaSetMainHeroRequest::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaSetMainHeroRequest(*this);
}

void ArenaBuildLevelQuoteRequest::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaBuildLevelQuoteRequest(*this);
}

void ArenaBuildDwellingWithLevel::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaBuildDwellingWithLevel(*this);
}

void ArenaSummonFromTown::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaSummonFromTown(*this);
}

void ArenaCommandChannelClientResponse::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaCommandChannelClientResponse(*this);
}

void ArenaDeploymentReady::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaDeploymentReady(*this);
}

void ArenaDeploymentPlanCommit::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaDeploymentPlanCommit(*this);
}

void ArenaArtifactDraftPick::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitArenaArtifactDraftPick(*this);
}
...
void LobbyAuthRequest::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitLobbyAuthRequest(*this);
}

void LobbyAuthResult::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitLobbyAuthResult(*this);
}

void LobbyServerRedirect::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitLobbyServerRedirect(*this);
}
...
void LobbyClientAbandonGame::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitLobbyClientAbandonGame(*this);
}
...
void LobbySetPlayerReady::visitTyped(ICPackVisitor & visitor)
{
	visitor.visitLobbySetPlayerReady(*this);
}

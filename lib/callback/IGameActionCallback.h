...
public:
	...
	virtual void arenaDeploymentReady()=0;
	virtual void arenaDeploymentPlanCommit(int32_t day, QueryID draftQueryID,
		...
		const std::vector<std::string> & atomicActionIds)=0;
	virtual void arenaArtifactDraftPick(QueryID queryID, int32_t candidateIndex)=0;

...
public:
	...
	void visitSetArenaCreatureExperience(SetArenaCreatureExperience & pack) override;
	void visitSetArenaRecruitState(SetArenaRecruitState & pack) override;
	...
	void visitSetStackArenaInitialUnit(SetStackArenaInitialUnit & pack) override;

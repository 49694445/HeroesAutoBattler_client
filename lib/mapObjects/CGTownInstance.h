...
public:
	...
	/// Overrides faction selection for this random town during the next pickRandomObject call.
	void setForcedRandomFaction(FactionID faction);
...
private:
	std::optional<FactionID> forcedRandomFaction;

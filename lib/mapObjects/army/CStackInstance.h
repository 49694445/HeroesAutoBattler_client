...
public:
	...
	bool isArenaInitialUnit() const;
	void setArenaInitialUnit(bool value);
	...
	void serialize(Handler & h)
	{
		...
		if(h.hasFeature(Handler::Version::ARENA_INITIAL_UNIT))
			h & arenaInitialUnit;
		else
			arenaInitialUnit = false;
	}

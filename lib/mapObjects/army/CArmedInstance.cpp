...
{
	// During combat, BattleInfo is authoritative. The battlefield may use a
	// terrain override, and dynamically created network armies do not
	// necessarily have a client-visible adventure-map position.
	if(battle)
		return battle->terrainType;

...
public:
	...
	void visitSetArenaHealth(SetArenaHealth & pack) override;
	void visitSetArenaHeroLevelUpChoiceTimeout(SetArenaHeroLevelUpChoiceTimeout & pack) override;
	void visitSetArenaBattleResultTimeout(SetArenaBattleResultTimeout & pack) override;
	void visitSetArenaSummonsRemaining(SetArenaSummonsRemaining & pack) override;
	void visitArenaDeploymentStarted(ArenaDeploymentStarted & pack) override;
	void visitArenaNativeProbeResult(ArenaNativeProbeResult & pack) override;
	void visitArenaArtifactDraftSelection(ArenaArtifactDraftSelection & pack) override;
	void visitArenaDailyResourceGrant(ArenaDailyResourceGrant & pack) override;
	void visitArenaDisconnectWaitState(ArenaDisconnectWaitState & pack) override;
	void visitArenaCommandChannelClientRequest(ArenaCommandChannelClientRequest & pack) override;
	void visitSetArenaTownVisitState(SetArenaTownVisitState & pack) override;
	void visitSetArenaTownBuildGateState(SetArenaTownBuildGateState & pack) override;
	void visitSetArenaMainHero(SetArenaMainHero & pack) override;
	void visitSetArenaBuildLevelState(SetArenaBuildLevelState & pack) override;
	void visitSetArenaTownSummonState(SetArenaTownSummonState & pack) override;
	void visitSetArenaBattleCreatureProgress(SetArenaBattleCreatureProgress & pack) override;

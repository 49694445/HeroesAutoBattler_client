...
private:
	...
	std::shared_ptr<CLabel> arenaNextBattleTerrainLabel;
	std::shared_ptr<ArenaHeroSnapshotPortrait> arenaPreviousEnemyHeroPortrait;
...
public:
	...
	void ensureArenaDeploymentTimer();
	void refreshArenaNextBattleTerrainLabel();
	void refreshArenaPreviousEnemyHeroPortrait();

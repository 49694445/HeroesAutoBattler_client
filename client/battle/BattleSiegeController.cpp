	...
	town(siegeTown)
{
	...
	{
		// Background is rendered by BattleFieldController; the gate is initially
		// closed and has no image to display in this state.
		if (g == EWallVisual::BACKGROUND || g == EWallVisual::GATE)
			continue;

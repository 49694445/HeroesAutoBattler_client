...
class BattleInterface
{
	...
	/// Sound channel whose completion unlocks the battle interface.
	/// Kept so an asynchronously ending battle can detach the callback safely.
...
public:
	...
	void showEnemyHeroWindow(const CGHeroInstance * hero) const;

...
private:
	...
	std::shared_ptr<CLabel> arenaTimeoutLabel;
	CPlayerInterface & owner;
	QueryID arenaQueryID = QueryID::NONE;
...
public:
	BattleResultWindow(const BattleResult & br, CPlayerInterface & _owner, bool allowReplay = false, QueryID arenaQueryID = QueryID::NONE, int32_t arenaTimeoutSeconds = -1);
	bool setArenaTimeout(QueryID queryID, int32_t remainingSeconds);
	void closeAfterArenaServerConfirmation();

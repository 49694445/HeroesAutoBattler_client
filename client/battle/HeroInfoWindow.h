...
private:
	...
	std::function<void()> onPortraitClick;

	Rect portraitArea() const;

public:
	HeroInfoBasicPanel(const InfoAboutHero & hero, const Point * position, bool initializeBackground = true, std::function<void()> onPortraitClick = {});

	void show(Canvas & to) override;
	bool receiveEvent(const Point & cursorPosition, int eventType) const override;

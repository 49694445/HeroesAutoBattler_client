...
public:
	CLevelWindow(const CGHeroInstance *hero, PrimarySkill pskill, std::vector<SecondarySkill> &skills, QueryID queryID, int32_t arenaTimeoutSeconds, std::function<void(ui32)> callback);

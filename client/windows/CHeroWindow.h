...
class CHeroSwitcher : public CIntObject
{
	...
	std::shared_ptr<CIntObject> mainHeroMarker;
	CHeroWindow * owner;
public:
	void clickPressed(const Point & cursorPosition) override;
	void refreshArenaMainHeroMarker();
...
public:
	...
	CHeroWindow(const CGHeroInstance * hero, bool readOnly = false, std::function<void()> closeCallback = {});
	...
	void refreshArenaMainHeroMarkers();

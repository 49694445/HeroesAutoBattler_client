...
/// Returns the mode-appropriate confirmation text for dismissing a creature stack.
/// Arena deployment uses a dedicated warning because the server removes the whole upgrade family.
...
public:
	...
	bool transfersEnabled = true; ///< cross-garrison troop movement is permitted
	...
	void setTransfersEnabled(bool enabled) { transfersEnabled = enabled; }

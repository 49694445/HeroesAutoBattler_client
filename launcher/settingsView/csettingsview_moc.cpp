	...
	: QWidget(parent), ui(new Ui::CSettingsView)
{
	...
	for(const auto * name : {"lineEditRepositoryDefault", "lineEditRepositoryExtra", "buttonRepositoryDefault", "buttonRepositoryExtra",
		"labelRepositoryDefault", "labelRepositoryExtra", "refreshRepositoriesButton", "buttonConfigEditor", "labelConfigEditor"})

...
static const std::array<std::string, 27> languageTranslatedNamesGenerator = {
	{
		...
		QT_TRANSLATE_NOOP("Language", "Greek"),
		...
		QT_TRANSLATE_NOOP("Language", "Latvian"),
...
void Languages::fillLanguages(QComboBox * widget, bool includeAll)
{
	...
	for(const auto & language : Languages::getLanguageList())
	{
		...
		if(!includeAll && language.identifier != "english" && language.identifier != "chinese") continue;
#endif

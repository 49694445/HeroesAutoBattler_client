...
namespace fuzzylite {
    ...
    void FunctionFactory::registerOperators() {
        ...
        registerObject(
            "!", new Function::Element("!", "Logical NOT", Function::Element::Operator, &(Op::logicalNot), p, 1)
        );  // logical not
        registerObject(
            "~", new Function::Element("~", "Negation", Function::Element::Operator, &(Op::negate), p, 1)
        );  // ~ negates a number
        ...
        registerObject(
            "*", new Function::Element("*", "Multiplication", Function::Element::Operator, &(Op::multiply), p)
        );
        registerObject("/", new Function::Element("/", "Division", Function::Element::Operator, &(Op::divide), p));
        registerObject("%", new Function::Element("%", "Modulo", Function::Element::Operator, &(Op::modulo), p));

        p -= 10;
        // Fourth order: addition, subtraction
        registerObject("+", new Function::Element("+", "Addition", Function::Element::Operator, &(Op::add), p));
        registerObject("-", new Function::Element("-", "Subtraction", Function::Element::Operator, &(Op::subtract), p));

        // Fifth order: logical and, logical or
        p -= 10;  // Logical AND
        registerObject(
            Rule::andKeyword(),
            new Function::Element(Rule::andKeyword(), "Logical AND", Function::Element::Operator, &(Op::logicalAnd), p)
        );
        p -= 10;  // Logical OR
        registerObject(
            Rule::orKeyword(),
            new Function::Element(Rule::orKeyword(), "Logical OR", Function::Element::Operator, &(Op::logicalOr), p)
        );
    }
    ...
    void FunctionFactory::registerFunctions() {
        ...
        registerObject(
            "asin", new Function::Element("asin", "Inverse sine", Function::Element::Function, &(std::asin))
        );
        registerObject(
        ...
        registerObject(
            "sinh", new Function::Element("sinh", "Hyperbolic sine", Function::Element::Function, &(std::sinh))
        );
        registerObject("sqrt", new Function::Element("sqrt", "Square root", Function::Element::Function, &(std::sqrt)));
        registerObject("tan", new Function::Element("tan", "Tangent", Function::Element::Function, &(std::tan)));
        registerObject(
            "tanh", new Function::Element("tanh", "Hyperbolic tangent", Function::Element::Function, &(std::tanh))
        );
        ...
        registerObject(
            "asinh", new Function::Element("asinh", "Inverse hyperbolic sine", Function::Element::Function, &(asinh))
        );
        registerObject(

...
public:
	...
	const std::vector<int64_t> & getSrcIndex() const override
	{
		return srcIndex;
	}
	const std::vector<int64_t> & getDstIndex() const override
	{
		return dstIndex;
	}
	const std::vector<float> & getAttributes() const override
	{
		return attributes;
	}

...
// A Q fast-resolve call uses the exact same model and inputs. The flag only
// suppresses diagnostics on the current inference thread.
inline thread_local bool losslessFastResolveInference = false;

class ScopedLosslessFastResolveInference
{
public:
	explicit ScopedLosslessFastResolveInference(bool enabled)
		: previous(losslessFastResolveInference)
	{
		losslessFastResolveInference = enabled;
	}

	~ScopedLosslessFastResolveInference()
	{
		losslessFastResolveInference = previous;
	}

	ScopedLosslessFastResolveInference(const ScopedLosslessFastResolveInference &) = delete;
	ScopedLosslessFastResolveInference & operator=(const ScopedLosslessFastResolveInference &) = delete;
